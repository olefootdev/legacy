...
import type { CoachCommand, LivePrematchBundle, LiveStoryRuntime } from '@/gamespirit/storyContracts';
 ...
 */
export declare const FOOTBALL_TOTAL_SECONDS = 5400;
export declare const SECONDS_PER_TICK = 60;
/** Duração real (ms) da animação de antecipação antes de confirmar o golo na UI. */
export declare const PRE_GOAL_DURATION_MS = 3000;
