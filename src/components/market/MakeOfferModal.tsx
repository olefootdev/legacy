...
export function MakeOfferModal({
  ...
  return (
    ...
    >
      <div
        className="relative w-full max-w-md overflow-hidden rounded-lg border border-white/10 bg-panel p-6 pl-7"
      ...
      >
        ...
        <label className="mt-4 block">
          ...
          <input
            ...
            className="mt-1 w-full rounded-md border border-white/20 bg-deep-black px-3 py-3 font-display text-lg font-bold text-white focus:border-neon-yellow focus:outline-none"
          />
        </label>
