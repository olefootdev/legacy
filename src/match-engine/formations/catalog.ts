...
export const FORMATION_BASES: Record<FormationSchemeId, Record<string, BaseSlot>> = {
  '4-3-3': {
    ...
    zag1: { nx: 0.288, nz: 0.38, line: 'def' },
    zag2: { nx: 0.288, nz: 0.62, line: 'def' },
    le: { nx: 0.323, nz: 0.12, line: 'def' },
    ld: { nx: 0.323, nz: 0.88, line: 'def' },
    vol: { nx: 0.417, nz: 0.5, line: 'mid' },
    mc1: { nx: 0.458, nz: 0.32, line: 'mid' },
    mc2: { nx: 0.458, nz: 0.68, line: 'mid' },
    pe: { nx: 0.557, nz: 0.2, line: 'att' },
    ata: { nx: 0.592, nz: 0.5, line: 'att' },
    pd: { nx: 0.557, nz: 0.8, line: 'att' },
  },
  '4-4-2': {
    gol:  { nx: 0.080, nz: 0.500, line: 'def' },
    le:   { nx: 0.288, nz: 0.100, line: 'def' },
    zag1: { nx: 0.288, nz: 0.360, line: 'def' },
    zag2: { nx: 0.288, nz: 0.640, line: 'def' },
    ld:   { nx: 0.288, nz: 0.900, line: 'def' },
    vol:  { nx: 0.446, nz: 0.100, line: 'mid' },
    mc1:  { nx: 0.446, nz: 0.360, line: 'mid' },
    mc2:  { nx: 0.446, nz: 0.640, line: 'mid' },
    pd:   { nx: 0.446, nz: 0.900, line: 'mid' },
    ata:  { nx: 0.592, nz: 0.380, line: 'att' },
    pe:   { nx: 0.592, nz: 0.620, line: 'att' },
  },
  '4-2-3-1': {
    gol:  { nx: 0.080, nz: 0.500, line: 'def' },
    zag1: { nx: 0.288, nz: 0.380, line: 'def' },
    zag2: { nx: 0.288, nz: 0.620, line: 'def' },
    le:   { nx: 0.315, nz: 0.120, line: 'def' },
    ld:   { nx: 0.315, nz: 0.880, line: 'def' },
    vol:  { nx: 0.371, nz: 0.400, line: 'mid' },
    mc2:  { nx: 0.371, nz: 0.600, line: 'mid' },
    mc1:  { nx: 0.47, nz: 0.500, line: 'mid' },
    pe:   { nx: 0.493, nz: 0.220, line: 'mid' },
    pd:   { nx: 0.493, nz: 0.780, line: 'mid' },
    ata:  { nx: 0.592, nz: 0.500, line: 'att' },
  },
  '3-5-2': {
    gol:  { nx: 0.080, nz: 0.500, line: 'def' },
    zag1: { nx: 0.288, nz: 0.320, line: 'def' },
    zag2: { nx: 0.288, nz: 0.500, line: 'def' },
    ld:   { nx: 0.288, nz: 0.680, line: 'def' },
    le:   { nx: 0.378, nz: 0.080, line: 'mid' },
    vol:  { nx: 0.4, nz: 0.500, line: 'mid' },
    mc1:  { nx: 0.457, nz: 0.280, line: 'mid' },
    mc2:  { nx: 0.457, nz: 0.720, line: 'mid' },
    pe:   { nx: 0.491, nz: 0.500, line: 'mid' },
    ata:  { nx: 0.592, nz: 0.400, line: 'att' },
    pd:   { nx: 0.592, nz: 0.600, line: 'att' },
  },
  '4-5-1': {
    gol:  { nx: 0.080, nz: 0.500, line: 'def' },
    zag1: { nx: 0.288, nz: 0.360, line: 'def' },
    zag2: { nx: 0.288, nz: 0.640, line: 'def' },
    le:   { nx: 0.324, nz: 0.100, line: 'def' },
    ld:   { nx: 0.324, nz: 0.900, line: 'def' },
    vol:  { nx: 0.397, nz: 0.500, line: 'mid' },
    mc1:  { nx: 0.446, nz: 0.250, line: 'mid' },
    mc2:  { nx: 0.446, nz: 0.750, line: 'mid' },
    pe:   { nx: 0.489, nz: 0.120, line: 'mid' },
    pd:   { nx: 0.489, nz: 0.880, line: 'mid' },
    ata:  { nx: 0.592, nz: 0.500, line: 'att' },
  },
  '5-3-2': {
    gol:  { nx: 0.060, nz: 0.500, line: 'def' },
    zag1: { nx: 0.288, nz: 0.300, line: 'def' },
    zag2: { nx: 0.288, nz: 0.500, line: 'def' },
    le:   { nx: 0.288, nz: 0.700, line: 'def' },
    ld:   { nx: 0.335, nz: 0.120, line: 'def' },
    vol:  { nx: 0.335, nz: 0.880, line: 'def' },
    mc1:  { nx: 0.44, nz: 0.350, line: 'mid' },
    mc2:  { nx: 0.44, nz: 0.650, line: 'mid' },
    pe:   { nx: 0.487, nz: 0.500, line: 'mid' },
    ata:  { nx: 0.592, nz: 0.400, line: 'att' },
    pd:   { nx: 0.592, nz: 0.600, line: 'att' },
  },
  '3-4-3': {
    gol:  { nx: 0.080, nz: 0.500, line: 'def' },
    zag1: { nx: 0.288, nz: 0.350, line: 'def' },
    zag2: { nx: 0.288, nz: 0.650, line: 'def' },
    le:   { nx: 0.319, nz: 0.100, line: 'def' },
    ld:   { nx: 0.393, nz: 0.120, line: 'mid' },
    vol:  { nx: 0.408, nz: 0.500, line: 'mid' },
    mc1:  { nx: 0.445, nz: 0.320, line: 'mid' },
    mc2:  { nx: 0.445, nz: 0.680, line: 'mid' },
    pe:   { nx: 0.561, nz: 0.180, line: 'att' },
    ata:  { nx: 0.592, nz: 0.500, line: 'att' },
    pd:   { nx: 0.561, nz: 0.820, line: 'att' },
  },
};
