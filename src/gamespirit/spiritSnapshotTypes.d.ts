...
export type SpiritPhase = 'open_play' | 'shot_resolve' | 'buildup_gk' | 'set_piece' | 'penalty' | 'celebration_goal';
...
export type HomeShotLogicalOutcome = 'goal' | 'post_in' | 'save' | 'block' | 'wide' | 'post_out' | 'miss_far';
