...
export const SHOT_XG_CAP = 0.44;
export const SHOT_P_ON_TARGET_CAP = 0.76;
...
/** Passe interceptado: largura da “janela” na linha passador→alvo (m) — ligeiramente maior = mais cortes de linha legíveis */
export const PASS_INTERCEPT_LINE_DIST = 3.15;
/** Teto de probabilidade após atributos + leitura; passes perfeitos ainda podem escapar via `passInterceptMultiplierForTier`. */
export const PASS_INTERCEPT_PROB_CAP = 0.62;
