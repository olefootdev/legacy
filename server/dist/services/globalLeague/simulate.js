...
export function effectiveOverall(team) {
...
export function simulateFixture(fx, effHome, effAway, kickoffMs) {
    ...
    for (let i = 0; i < homeGoals; i++)
        placeGoal('home', i, homeGoals);
    for (let i = 0; i < awayGoals; i++)
        placeGoal('away', i, awayGoals);
...
export function updateTeamRow(team, gf, ga, isPlayoff) {
