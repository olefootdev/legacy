...
- **Elementos:** cruz de malta sugerida na diagonal; anos **2005–2006**; OVR **80**.
...
- **Elementos:** escudo do Botafogo-SP; janela **2008–2014**; OVR **85**; selo de **Épico**.
- **Detalhe narrativo:** o apelido **"GUERREIRO"** pode aparecer como tipografia de fundo, grande e rebaixada em opacidade, atrás do retrato. É o nome que a torcida deu — é a identidade do card.
- **Toque de coleção:** três continentes (Brasil, Europa, Ásia) podem virar três marcas mínimas na borda inferior — sutil, quase um rodapé.

---

## Regras que valem pros três

1. **Retrato 2:3 vertical**, rosto no terço superior (o recorte do card favorece o alto da imagem).
2. **Nada de referência a doença, hospital ou transplante na arte.** A história de superação é do briefing e da comunicação — os cards celebram o jogador em campo. Inegociável.
3. **Sem imagem de terceiros** (Romário, adversários) nas artes.
4. **Escudos discretos** — o protagonista é ele, o clube é contexto.
5. Nomes curtos e distintos por fase (**AME / VAS / BSP**) — mesmo padrão de sigla de clube do Adauto (STA / PR / SLV), pra coleção ficar coerente.
